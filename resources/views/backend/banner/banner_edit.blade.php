				...
				<div class="container">
					<div class="main-body">
						<div class="row">
							...
							<div class="col-lg-12">
							 <form id="myForm" action="{{route('update.banner', $banner->id)}}" method="post" enctype="multipart/form-data">
								@csrf
								...
								<div class="card">
									<div class="card-body">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="file" name="banner_image" class="form-control form-group" id="image" />
											</div>
										</div>
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<img  id="showImage" src="{{asset($banner->banner_image)}}" alt="Admin"  width="110">
											</div>
										</div>
										<div class="row">
