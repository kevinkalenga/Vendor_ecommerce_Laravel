								...
								<div class="card">
									<div class="card-body">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<img  id="showImage"  src="{{(!empty($activeVendorDetails->photo)) ? url('upload/vendor_images/'.$activeVendorDetails->photo) : url('upload/default_avatar.jpg')}}" alt="Vendor" class="rounded-circle p-1 bg-primary" width="110">
											</div>
										</div>
