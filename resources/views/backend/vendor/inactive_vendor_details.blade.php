								...
								<div class="card">
									<div class="card-body">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<textarea name="vendor_short_info" class="form-control" name="vendor_short_info" id="inputAddress2" placeholder="Vendor Info" rows="3">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<img  id="showImage"  src="{{(!empty($inactiveVendorDetails->photo)) ? url('upload/vendor_images/'.$inactiveVendorDetails->photo) : url('upload/default_avatar.jpg')}}" alt="Vendor" class="rounded-circle p-1 bg-primary" width="110">
											</div>
										</div>
